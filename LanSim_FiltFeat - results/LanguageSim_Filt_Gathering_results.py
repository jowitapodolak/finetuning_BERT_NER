...
# 3) Gather f1 scores and loss_eval
    ...
    for index, row in undertaken_experiments.iterrows():
        ...
        for i in range(1,5):
            ...
            path_to_result ="results_" + str(round(row['DIST'],2)) + "/output_" + str(round(row['DIST'],2)) + "/" + str(row['LAN_1']) + "_" + str(row['LAN_2']) + "_" + str(i) + "/eval_results.txt"
